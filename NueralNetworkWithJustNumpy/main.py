...
print('Loading data......')
sub_train_images, sub_train_labels, sub_test_images, sub_test_labels = init_subset('0000')

net = Net()
epoch = 10            ### Default number of epochs 10
...
def evaluate(net, images, labels):
    ...
    pass
    print(range(0, images.shape[0], batch_size))
